...
contains
    subroutine recom_atbox(MPI_COMM_FESOM, myDim_nod2D, eDim_nod2D, ulevels_nod2D, areasvol, dt)
        ...
        ! mean density of air = 0.02897 kg / mol
        ! (https://nssdc.gsfc.nasa.gov/planetary/factsheet/earthfact.html)
        ! => total molecular inventory of the dry atmosphere: moles_atm = 1.7726e20 mol ==
        ! constant.
        ...
        if (ciso) then
            ...
            if (ciso_14) then
                ...
                ! lambda_14 - total_co2flux_14)
                ! = (mol_co2atm_14  + dt * (cosmic_14(1) - total_co2flux_14))
                ! / (1 + lambda_14 * dt)
                ! Budget in terms of the 14C / 12C volume mixing ratio
                x_co2atm_14(1) = (x_co2atm_14(1) &
                        + dt * (cosmic_14(1) - total_co2flux_14) / mol_allatm * 1.e6) / &
                        (1 + lambda_14 * dt)
