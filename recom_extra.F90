...
contains
    ...
    subroutine krill_resp(n, daynew, geo_coord_nod2D)
        ...
        if (geo_coord_nod2D(2, n) < 0.0_WP) then !SH
            ...
            else if ((150 < daynew) .and. (daynew < 250)) then
                res_zoo2_a = -0.5
            else if ((250 <= daynew) .and. (daynew <= 295)) then
                res_zoo2_a = (1 / 90.) * daynew - 59. / 18.
            else if ((daynew > 295)) then
                res_zoo2_a = 0.d0
            end if
        else
            if ((daynew <= 65)) then
                res_zoo2_a = -0.5
            else if ((285 <= daynew) .and. (daynew <= 330)) then
                res_zoo2_a = (-1. / 90.) * daynew + 57. / 18.
            else if ((330 < daynew)) then
                res_zoo2_a = -0.5
            else if ((65 <= daynew) .and. (daynew <= 110)) then
                res_zoo2_a = (1 / 90.) * daynew - 22. / 18.
            else if ((110 < daynew) .and. (daynew < 285)) then
                res_zoo2_a = 0.d0
            end if
        end if
