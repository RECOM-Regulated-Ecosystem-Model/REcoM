    ...
    subroutine REcoM_sms(n, nzmin, Nn, state, thick, SurfSR, sms, Temp, Sali_depth, CO2_watercolumn, &
        ...
        do step = one, biostep
            ...
            do k = nzmin, nn
                ...
                call calculate_carbonate_chemistry(k, zF, dt_b, mstep, SurfSR, Latd, &
                        REcoM_T_depth, REcoM_S_depth, REcoM_Alk_depth, REcoM_DIC_depth, &
                        REcoM_Si_depth, REcoM_Phos_depth, Patm_depth, CO2_watercolumn, &
                        pH_watercolumn, pCO2_watercolumn, HCO3_watercolumn, CO3_watercolumn, &
                        OmegaC_watercolumn, kspc_watercolumn, rhoSW_watercolumn)
